...
<template>
    <div id="app">
        <div class="bordered-with-shadow"
            style="width: 220px;height:100vh; background-color:#FFFFFF;text-align: left;font-weight: bold;">
            ...
            <div :class="value == 3 ? 'custom-style' : 'falst-custom-style'" @click="toEscort()">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" class="icon"
                    version="1.1" viewBox="0 0 1024 1024" width="16" height="16" style="" filter="#231815">
                    <g>
                        <path
                            d="M832 160h-640A128.1 128.1 0 0 0 64 288v448a128.1 128.1 0 0 0 128 128h640A128.1 128.1 0 0 0 960 736V288A128.1 128.1 0 0 0 832 160z m64 576a64.1 64.1 0 0 1-64 64h-640a64.1 64.1 0 0 1-64-64V288a64.1 64.1 0 0 1 64-64h640a64.1 64.1 0 0 1 64 64z"
                            fill="#231815" p-id="1719" stroke="none"></path>
                        <path
                            d="M697.7 482.8a112 112 0 1 0-179.4 0A224.3 224.3 0 0 0 384 688a32 32 0 0 0 64 0 160 160 0 0 1 320 0 32 32 0 1 0 64 0 224.3 224.3 0 0 0-134.3-205.2zM560 416a48 48 0 1 1 48 48 48 48 0 0 1-48-48zM224 416h192a32 32 0 0 0 0-64H224a32 32 0 0 0 0 64zM352 480H224a32 32 0 0 0 0 64h128a32 32 0 0 0 0-64zM288 608h-64a32 32 0 1 0 0 64h64a32 32 0 0 0 0-64z"
                            fill="#231815" p-id="1720" stroke="none"></path>
                    </g>
                </svg>
                &nbsp;&nbsp;&nbsp;
                陪诊师管理
            ...
            <div :class="value == 5 ? 'custom-style' : 'falst-custom-style'" @click="toServe">
                <svg t="1719543808901" class="icon" viewBox="0 0 1024 1024" version="1.1"
                    xmlns="http://www.w3.org/2000/svg" p-id="3662" width="16" height="16">
                    <path
...
.custom-style {
    position: relative;
    /* Added for absolute positioning of inner text */
    left: 10px;
    width: 200px;
    height: 52px;
    line-height: 20px;
