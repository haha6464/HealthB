            ...
            <div class="grid-content bg-purple">
              ...
              >
                <div style="margin-top: 20px;">
                  ...
                  <span
                    style="font-size:14px;float:left;margin-top:6px;margin-left:15px;"
                    >状态&nbsp;</span
                  >
                  ...
                  <div style="float:left;margin-left:100px;margin-top:1px"  @click="seachButton()">
                    <Button value="批量操作" ></Button>
                  </div>
                  <div
                    style="float:left;margin-left:100px;"
                    @click="showChildModal"
                  >
                    <Button value="发布服务"></Button>
                  </div>
                </div>
...
import List from "../serve/component/List.vue";
import Button from "../../../components/button/Button.vue";
import Edtion from "../serve/component/Edtion.vue";
