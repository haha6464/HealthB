...
public class UserServiceImpl implements UserService {
    ...
    public Map<String, Object> login(LoginDTO loginDTO) {
        ...
        QueryWrapper<huice.accompaniment.pojo.DO.UserDO> queryWrapper = new QueryWrapper<>();
        queryWrapper.eq("username", username);
        queryWrapper.eq("password", pwd);
        huice.accompaniment.pojo.DO.UserDO userDO = userMapper.selectOne(queryWrapper);
    ...
    public Boolean addPatient(PatientDTO patient) {
        ...
        huice.accompaniment.pojo.DO.UserDO userDO = userMapper.selectById(patient.getUid());
